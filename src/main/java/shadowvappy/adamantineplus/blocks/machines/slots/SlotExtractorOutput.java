...
import shadowvappy.adamantineplus.blocks.machines.extractor.StrandExtractorRecipes;
...
public class SlotExtractorOutput extends SlotItemHandler {
    ...
    public SlotExtractorOutput(EntityPlayer player, IItemHandler itemHandler, int index, int x, int y) {
    ...
    protected void onCrafting(ItemStack stack) {
        ...
        if(!this.player.world.isRemote){
            ...
            float f = StrandExtractorRecipes.getInstance().getExtractingExperience(stack);

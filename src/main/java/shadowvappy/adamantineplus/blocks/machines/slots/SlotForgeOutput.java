...
import shadowvappy.adamantineplus.blocks.machines.forge.AdamantineForgeRecipes;
...
public class SlotForgeOutput extends SlotItemHandler {
    ...
    public SlotForgeOutput(EntityPlayer player, IItemHandler itemHandler, int index, int x, int y) {
    ...
    protected void onCrafting(ItemStack stack) {
        ...
        if(!this.player.world.isRemote){
            ...
            float f = AdamantineForgeRecipes.getInstance().getForgingExperience(stack);

...
public class GuiStrandExtractor extends GuiContainer {
    private static final ResourceLocation TEXTURES = new ResourceLocation(APModReference.MODID + ":textures/gui/gui_strand_extractor.png");
    private final InventoryPlayer player;
    private final TileEntityStrandExtractor tileEntity;

    public GuiStrandExtractor(InventoryPlayer player, TileEntityStrandExtractor tileEntity) {
        super(new ContainerStrandExtractor(player, tileEntity));
        this.player = player;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if(TileEntityStrandExtractor.isBurning(tileEntity)) {

...
public class StrandExtractorRecipes {
    private static final StrandExtractorRecipes INSTANCE = new StrandExtractorRecipes();
    ...
    public static StrandExtractorRecipes getInstance() {
        return INSTANCE;
    }

    private StrandExtractorRecipes() {
        addExtractingRecipe(new ItemStack(Blocks.WOOL, 1, 0), new ItemStack(Items.STRING, 3), 0.2F, 200);
        addExtractingRecipe(new ItemStack(APModItems.adamantineRaw), new ItemStack(APModItems.adamantineStrand), 2.0F, 19200);
    }
     ...
     */
    public void addExtractingRecipe(ItemStack input, ItemStack result, float experience, int time) {
        if(getExtractingResult(input) != ItemStack.EMPTY) return;
     ...
     */
    public int getExtractingTime(ItemStack input) {

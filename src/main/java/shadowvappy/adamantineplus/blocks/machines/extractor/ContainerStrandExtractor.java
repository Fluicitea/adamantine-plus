...
import shadowvappy.adamantineplus.blocks.machines.slots.SlotExtractorOutput;

import javax.annotation.ParametersAreNonnullByDefault;

@MethodsReturnNonnullByDefault
@ParametersAreNonnullByDefault
public class ContainerStrandExtractor extends Container {
    private final TileEntityStrandExtractor tileEntity;
     ...
     */
    public ContainerStrandExtractor(InventoryPlayer player, TileEntityStrandExtractor tileEntity) {
        ...
        this.addSlotToContainer(new SlotExtractorOutput(player.player, handler, 2, 113, 18));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if(slot != null && slot.getHasStack()) {
            ...
            if(index == 2) {
                ...
                if(!StrandExtractorRecipes.getInstance().getExtractingResult(stack1).isEmpty()) {

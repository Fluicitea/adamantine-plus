...
public class BlockStrandExtractor extends Block {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if(!worldIn.isRemote)
            playerIn.openGui(Main.instance, APModReference.GUI_STRAND_EXTRACTOR, worldIn, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
    ...
    @Override
    public TileEntity createTileEntity(World world, IBlockState state) { return new TileEntityStrandExtractor(); }
}